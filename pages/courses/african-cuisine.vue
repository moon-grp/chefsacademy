  ...
  <div>
    <v-row>
      <v-carousel :show-arrows="false" hide-delimiters height="50vh">
        <v-carousel-item src="https://res.cloudinary.com/sparaclet-inc/image/upload/v1645211745/chefsacademy/photo5800683805667867022_j9i96d.jpg" aspect-ratio="1"></v-carousel-item>
      </v-carousel>
    ...
    <v-row class="mt-4">
      <v-container class="mb-6">
        ...
        Our students will explore diffrent african cuisine and our professional chefs will tutor students <br/>
        how to treat and present affrican food in a dynamic way.
        </div>
        ...
        <div class="mt-4">
          <v-list-item two-line>
            <v-list-item-content>
              ...
              <v-list-item-subtitle
                >3 weeks(3 days a week)</v-list-item-subtitle
              >
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item two-line>
            <v-list-item-content>
              ...
              <v-list-item-subtitle
                >₦ 180,000 (5,000 registration fee)</v-list-item-subtitle
              >
            </v-list-item-content>
          </v-list-item>
        </div>
