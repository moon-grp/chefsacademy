  ...
  <div>
    <v-row>
      <v-carousel :show-arrows="false" hide-delimiters height="50vh">
        <v-carousel-item src="https://res.cloudinary.com/sparaclet-inc/image/upload/v1642946452/chefsacademy/pa_m0kejp.jpg" aspect-ratio="1"></v-carousel-item>
      </v-carousel>
    ...
    <v-row class="mt-4">
      <v-container class="mb-6">
        <div class="text-capitalize fon">
         pastry and dessert art
        </div>

        <div class="mt-4 text-left fntcc">
          This course is an absolute treat. it will help you understand the<br>
           fundermental techniques and methods for pastries amd preparing desserts
        </div>
          ...
          <v-list-item two-line>
            <v-list-item-content>
              ...
              <v-list-item-subtitle
                >4 weeks(3 days a week)</v-list-item-subtitle
              >
            </v-list-item-content>
          </v-list-item>
