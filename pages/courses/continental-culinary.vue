  ...
  <div>
    <v-row>
      <v-carousel :show-arrows="false" hide-delimiters height="50vh">
        <v-carousel-item src="https://res.cloudinary.com/sparaclet-inc/image/upload/v1645211744/chefsacademy/photo5800683805667867020_pxlsui.jpg" aspect-ratio="1"></v-carousel-item>
      </v-carousel>
    ...
    <v-row class="mt-4">
      <v-container class="mb-6">
        ...
        <div class="mt-4 text-left fntcc">
          Take your first step into continental culianry art world with our professional chefs to tutor you.<br/>
          with a practical and theorectica based outline, this program is not only career oriented,<br/>
           but also a great way to develop globally recorgnized excellence in this particular field.
        </div>
