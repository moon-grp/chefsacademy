  ...
  <div>
    <v-row>
      <v-carousel :show-arrows="false" hide-delimiters height="50vh">
        <v-carousel-item src="https://res.cloudinary.com/sparaclet-inc/image/upload/v1644158402/chefsacademy/photo5764796880008624514_babvdw.jpg" aspect-ratio="1"></v-carousel-item>
      </v-carousel>
    ...
    <v-row class="mt-4">
      <v-container class="mb-6">
       ...
       Understand the importance of basic health strategies for developing and maintaining a general nutrition of<br />
       having a healthy lifestyle with the effects on the body. Explore this cuisine with our certifed nutritionist.
        </div>
        ...
        <div class="mt-4">
          ...
          <v-list-item two-line>
            <v-list-item-content>
              ...
              <v-list-item-subtitle
                >₦ 280,000 (5,000 registration fee)</v-list-item-subtitle
              >
            </v-list-item-content>
          </v-list-item>
        </div>
