  ...
  <div>
    <v-row>
      <v-carousel :show-arrows="false" hide-delimiters height="50vh">
        <v-carousel-item src="https://res.cloudinary.com/sparaclet-inc/image/upload/v1645211745/chefsacademy/photo5800683805667867021_myuyea.jpg" aspect-ratio="1"></v-carousel-item>
      </v-carousel>
    ...
    <v-row class="mt-4">
      <v-container class="mb-6">
        ...
        <div class="mt-4 text-left fntcc">
          The professional diploma in culinary arts with resturant and
          entrepreneural management <br />
          outline includes commercial cooking, food safety, product knowledge,
          culinary fundamentals,<br />
          nutrition,and professionalism. Entrepreneurship, kitchen and resturant
          management,<br />
          customer service, writing and menu development, food cost control.
        </div>
          ...
          <v-list-item two-line>
            <v-list-item-content>
              ...
              <v-list-item-subtitle
                >9 months (3 days a week)</v-list-item-subtitle
              >
            </v-list-item-content>
          </v-list-item>
