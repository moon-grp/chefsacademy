  ...
  <div>
    <v-row>
      <v-carousel :show-arrows="false" hide-delimiters height="50vh">
        <v-carousel-item src="https://res.cloudinary.com/sparaclet-inc/image/upload/v1642946441/chefsacademy/ent_k9i5dr.jpg" aspect-ratio="1"></v-carousel-item>
      </v-carousel>
    ...
    <v-row class="mt-4">
      <v-container class="mb-6">
        ...
        <div class="mt-4 text-left fntcc">
          This course is designed for people who aspire to lead successful
          business venture; help <br />
          exisiting food, beverage and hospitality business to grow and
          capitalize on the unprecedented <br />
          entrepreneurial opportunities in the global food business.
        </div>
          ...
          <v-list-item two-line>
            <v-list-item-content>
              ...
              <v-list-item-subtitle
                >₦ 200,000 (5,000 registration fee)</v-list-item-subtitle
              >
            </v-list-item-content>
          </v-list-item>
        </div>
